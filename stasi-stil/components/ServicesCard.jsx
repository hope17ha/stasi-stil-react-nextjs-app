                ...
                return (
                    <div key={s.id} className="mb-16">
                        <article
                            ...
                            } items-center bg-gradient-to-br from-black/60 to-black/30 border border-gray-400 rounded-3xl shadow-2xl hover:scale-[1.02] transition-transform duration-500 ease-in-out max-w-4xl mx-auto`}
                        >
                            <div className="w-full md:w-1/2 relative h-72 sm:h-80 md:h-96 lg:h-96 flex-shrink-0 overflow-hidden rounded-2xl">
                                <img
                                    src={s.img}
                                    alt={s.alt}      
                            ...
                            <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center">
                                <h3 className="text-2xl sm:text-3xl md:text-3xl font-semibold text-[#b4ac77] mb-4">
                                    {s.title}
                                </h3>
                                <p className="text-white/80 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg md:text-lg">
                                    {s.description}
                                </p>
                        ...
                        <div
                            className={`transition-[max-height,opacity,margin-top] duration-700 ease-in-out overflow-hidden max-w-4xl mx-auto ${openMoreId === s.id ? "max-h-[1000px] opacity-100 mt-6" : "max-h-0 opacity-0 mt-0"}`}
                        >
                            <ul className="text-white/90 space-y-3 px-4 sm:px-10 py-6 sm:py-8 bg-black/40 rounded-3xl border border-gray-700 shadow-inner w-full">
                                {" "}
                                    ...
                                    >
                                        ...
                                        {price.byLength ? (
                                            <div className="flex justify-between sm:gap-10 text-[#b4ac77] font-semibold mt-2 sm:mt-0 text-sm sm:text-base">
                                                <span>
                                                    Къса: {price.byLength.short}
                                                </span>
                                                <span>
                                                    Средна:{" "}
                                                    {price.byLength.medium}
                                                </span>
                                                <span>
                                                    Дълга: {price.byLength.long}
                                                </span>
                                            </div>
                                        ) : (
